...
2. **心理学视角**（psychology_theory + psychology_explanation）：
   ...
   - 可选框架：荣格阴影、依恋理论、防御机制、马斯洛需求层次、
     ...
     叙事治疗、自我同情、阿德勒个体心理学
   - 【阿德勒个体心理学专属使用指南】若选此框架，必须切换到「目的论」视角：
     不问"这个情绪是被什么原因造成的"，而问"这个行为/感受在帮你达到什么目的？"
     核心问题是：这个模式让你得到了什么？（如：保留借口、回避挑战、维持关系）
     行动建议必须体现「课题分离」或「贡献感」其中之一——
     要么帮用户区分"这是我的课题还是别人的课题"，
     要么引导用户从"被困在自己内心"转向"如何对周围的人/事做出哪怕一点贡献"
...
7. **思维惯性**（cognitive_patterns）：
   - 0-2 个，没有就返回空数组，不要强行填；内容积极时不要强行贴标签
   - name 从以下列表中选：灾难化联想、非此即彼、读心术、把一切揽到自己身上、
     用感受下判断、以偏概全、过滤负面信息、应该句式
   - reason：1-2 句话（不要换行），结合用户这条具体想法说明「为什么」会出现这个惯性，
     语气温和，避免说教，让用户感到被理解而非被评判
...
返回严格的 JSON 格式，不要有任何额外文字：
{
  ...
  "cognitive_patterns": [
    {"name": "思维惯性名1", "reason": "结合用户这条想法的1-2句个性化说明"}
  ]
}
''';
...
3. **行动指南**（action_guide）：
   ...
   - 【阿德勒个体心理学专属使用指南】若指定框架为「阿德勒个体心理学」：
     - 深层解读必须切换到目的论视角：不追溯"原因"，而是探索"这个模式在帮你达到什么目的"
     - 行动建议必须体现课题分离（帮用户区分哪些是自己的课题、哪些是他人的课题）
       或贡献感（引导从内心困境转向一个小的、真实的外部连接或贡献动作）
     - 语气要保持温和，避免让用户觉得"你是在主动选择痛苦"的说教感
